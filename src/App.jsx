  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0F1117", color: "#E8E8E8", fontFamily: "'DM Sans', 'Helvetica Neue', sans-serif", padding: "2rem 1.5rem", maxWidth: "480px", margin: "0 auto" }}>
            ...
            <div>
              ...
              {rascunhos.map(r => (
                <div key={r.id} style={{ background: "#181B24", borderRadius: "16px", padding: "1.25rem", marginBottom: "0.75rem", border: "1px solid #252832" }}>
                  ...
                  {r.texto_original && <div style={{ background: "#0F1117", borderRadius: "8px", padding: "0.5rem 0.75rem", marginBottom: "0.75rem" }}><p style={{ margin: 0, fontSize: "0.72rem", color: "#555" }}>💬 "{r.texto_original}"</p></div>}
      ...
      {tela === "metas" && (() => {
        ...
        const labels = Array.from({ length: meses + 1 }, (_, i) => { if (i === 0) return "Hoje"; if (i % 12 === 0) return `${i / 12}a`; if (i === mesMeta) return "🎯"; return ""; });
          ...
          <div>
            ...
            {temDados && (
              <>
                ...
                {meta > 0 && mesMeta === -1 && <div style={{ background: "#EF44440F", borderRadius: "12px", padding: "1rem 1.25rem", marginBottom: "1rem", border: "1px solid #EF444430" }}><p style={{ margin: 0, fontSize: "0.85rem", color: "#EF4444" }}>⚠️ Com esse aporte, você não atinge a meta em 5 anos.</p></div>}
                <div style={{ background: "#181B24", borderRadius: "16px", padding: "1.5rem", border: "1px solid #252832" }}>
