...
import { ABAS_INTERNAS, CARTAO, CARTAO_RESUMO, VALOR_RESUMO, gradeResumo, LINHA, LINHA_ESQUERDA, LINHA_DIREITA } from "./molduras";
...
const st = {
  ...
  // Ver molduras.js.
  resumoRow: { ...gradeResumo(), marginBottom: 24 },
  ...
  resumoValor: { ...VALOR_RESUMO, color: "var(--text-primary, #F1F2F4)" },
  ...
  checkLabel: { display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: "var(--text-secondary, #8B93A1)", cursor: "pointer" },
