...
const st = {
  ...
  resumoValor: { fontSize: 20, fontWeight: 700, color: "#F1F2F4" },
  tabsRow: { display: "flex", gap: 4, marginBottom: 20, background: "var(--surface, #151821)", padding: 4, borderRadius: 10, width: "fit-content" },
  tab: { padding: "7px 16px", borderRadius: 7, fontSize: 13, fontWeight: 600, cursor: "pointer", color: "#8B93A1", border: "none", background: "transparent", fontFamily: "inherit" },
  tabActive: { background: "var(--surface2, #1E2330)", color: "#F1F2F4" },
  ...
  checkLabel: { display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: "#8B93A1", cursor: "pointer" },
  ...
  modal: { background: "var(--surface, #151821)", border: "1px solid var(--border, #2C3344)", borderRadius: 14, width: "100%", maxWidth: 520, maxHeight: "90vh", display: "flex", flexDirection: "column" },
